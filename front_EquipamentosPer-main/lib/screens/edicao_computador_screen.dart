...
class EdicaoComputadorScreen extends StatefulWidget {
  ...
  const EdicaoComputadorScreen({super.key, required this.computador});
...
class _EdicaoComputadorScreenState extends State<EdicaoComputadorScreen> {
  ...
  void initState() {
    ...
    _setorController = TextEditingController(text: c.setor);       // Inicializa Setor
    _operadorController = TextEditingController(text: c.operador); // Inicializa Operador
